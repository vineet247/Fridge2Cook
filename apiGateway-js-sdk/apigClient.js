...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://m7eltxnx8c.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.choicesPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var choicesPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/choices').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
        ...
        return apiGatewayClient.makeRequest(choicesPostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.choicesOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var choicesOptionsRequest = {
        ...
        return apiGatewayClient.makeRequest(choicesOptionsRequest, authType, additionalParams, config.apiKey);
    };
